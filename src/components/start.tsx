...
export default function Start() {
    return(
        <div className="flex justify-center bg-white p-32 mt-52 rounded-3xl shadow-xl mx-4">
            <div className="flex flex-col justify-center items-center gap-y-4 w-[90%]">
                ...
                <button className="bg-almostBlack text-white px-3 font-semibold rounded-full py-1 text-sm h-14 w-52 mt-12">Get Started For Free</button>
